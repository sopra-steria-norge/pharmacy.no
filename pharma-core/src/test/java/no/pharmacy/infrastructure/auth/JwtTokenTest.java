...
public class JwtTokenTest {
    ...
    private URL authority = IOUtil.url(System.getProperty("test.openid.authority", "https://difa-adfs-if.difa.ad/adfs"));
    ...
    private JwtToken jwtToken = new JwtToken(authority, sampleToken);
    ...
    public void shouldRejectForgedToken() throws Exception {
        ...
        assertThat(new JwtToken(authority, tokenValues[0] + "." + tokenValues[1] + "." + tokenValues[2]).verifySignature())
            .isFalse();
    }
}
